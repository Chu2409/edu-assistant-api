...
export class LoProgressController {
  ...
  @Post('visit')
  @ApiOperation({
    summary: 'Marcar un objeto de aprendizaje como visitado o completado',
  })
  @ApiResponse({ status: 201, type: LoProgressDto })
  markVisited(@GetUser('id') userId: number, @Body() dto: MarkLoVisitedDto) {
    return this.loProgressService.markVisited(userId, dto)
  }

  @Get(':learningObjectId')
  @ApiOperation({
    summary: 'Obtener el progreso de un estudiante en un objeto de aprendizaje',
  })
